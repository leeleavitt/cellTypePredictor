...
modelName = 'ramck'
traceFileName1 = "../trainingData/cell_types_R3J/R3J_7238.csv"
...
traces1 = pd.read_csv(traceFileName1, index_col=0)
traces1 = np.asarray(traces1)

traces2 = pd.read_csv(traceFileName2, index_col=0)
traces2 = np.asarray(traces2)

traces = np.concatenate((traces1, traces2), axis=1)
