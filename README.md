...
![](./structuredPrediction/modelMakers/history/cy5.png)
...
1. An image of brightFeild, CGRP(green), and IB4(red), was used to train a multiclass convolutional neural network, this is shown in **figure 4**.  The success of this model is shown in **figure 5**. Overall this was a very weak model. If i had more time I would assess per class success rate. To view the model see [this](./structuredPrediction/modelMakers/imageModel.py).

![](./structuredPrediction/misc/bf.gfp.tritc.end.png) 

**Figure 4:** bright feild overlay

![](./structuredPrediction/modelMakers/history/label.png) 
...
2. to understand the traces, three multi-class models were created. These model involved creating custom statistics at regular intervals along the traces. These were fed into a 1 dimension convolution neural network, then max pooled, and then sent into an LSTM. The LSTM had both dropout and recurrent dropout to prevent overfitting. A simple representation of the traces used for these networks are shown in **Figure 6**. Three different LSTM models were designed for this experiment;
    ...
    1. [RIIIJ](./structuredPrediction/modelMakers/r3jModel.py) shown in **figure 7**
    2. [Aitc, menthol, capsaicin K40 (AMCK)](./structuredPrediction/modelMakers/amckModel.py), shown in **figure 8**.
    3. [RIIIJ and AMCK (RAMCK)](./structuredPrediction/modelMakers/ramck.py), shown in **figure 9**.

All models were fairly weak for defining the cell types, and the the RAMCK performed the best see **figure 9**.

![](./structuredPrediction/misc/cellTypeSample.png).  
...
![](./structuredPrediction/misc/allClass_vs_binClass.png)
...
![](./structuredPrediction/misc/classMisClassification.png)
...
![](./structuredPrediction/misc/withinClassMisClassification.png)
...
![](./structuredPrediction/misc/cellClassPrediction.png)
...
![](./structuredPrediction/misc/bf.gfp.tritc.end.lab.png)
