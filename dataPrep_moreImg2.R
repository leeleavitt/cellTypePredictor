...
for(i in 1:length(rdExps) ){
    ...
    cellTypeName <- rev(grep('^cell[._]types$', names(tmpRD)))[1]
...
rdExps <- setdiff(goodRdExps, "RD.190828.40.m1.w1.5BDBD..JNJ..UDPga")
...
#imageExtractor(rdExps, 20, c('gfp.bin', 'cy5.bin'), 'img2', c(1,2,3) )
